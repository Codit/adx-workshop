...
In order to receive the "ADX-In-A-Day" digital badge, you will need to complete the tasks marked with ✅ in [Lab 1](/lab1/README.md) & Lab 2. Submit your answers for [Lab 1](https://forms.office.com/r/qZ0yghDwyb) and Lab 2 quizzes in order to receive the "ADX in a Day" digital badge. You may edit your answers after or try again.
...
![ADX in a day](/assets/images/lab1/badge.png "ADX in a day")
...
<details>
  ...
  ```kql
You can use a calculator to complete this task
  ```
</details>
...
<details>
  ...
  ```kql
.show database DatabaseName journal | where ChangeCommand has 'function'
  ```
</details>
...
<details>
  ...
  ```kql
.show commands 
| where StartedOn > ago(4h) and User == "YourEmail"
| project CommandType, StartedOn, AuthScheme = tostring(ClientRequestProperties.AuthorizationScheme)
|distinct AuthScheme
  ```
</details>
...
![Example Output for Question 7.4](/assets/images/lab2/Challenge7-Task4-Part2-Pic1.png "Example Output for Question 7.4")
...
![Example Result for Question 7.5](/assets/images/lab2/anomalies.png "Example Result for Question 7.5")
...
![Logs ordered by absolute Anomaly Score](/assets/images/lab2/anomalies_table.png "Logs ordered by absolute Anomaly Score")
...
![Create a new dashboard](/assets/images/lab2/Challenge8-goto-dashboard.png "Create a new dashboard")
...
![Define Dashboard Datasource](/assets/images/lab2/Challenge8-dashboard-datasource.png "Define Dashboard Datasource")

Use the cluster URI of your free cluster as the data source.

![URI of the free cluster](/assets/images/lab2/free_cluster_uri.png "URI of the free cluster")
...
|In the query window, explore the **Share** menu.|
  ...
  ![Share menu in query window](/assets/images/lab2/Challenge8-Task1-Pic1.png "Share menu in query window")
...
|Below is just an example dashboard.|
  ...
  ![Example Dashboard](/assets/images/lab2/Challenge8-Task1-dashboard-v2.png "Example Dashboard")
...
[Kusto Detective Agency](https://detective.kusto.io)
 ...
 ![Kusto Detective Agency Badge](/assets/images/lab2/kda_badge.png "Kusto Detective Agency Badge")
